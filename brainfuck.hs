...
-- ([)
-- If the byte at the data pointer (i.e. the focus of the Memory zipper) is zero
-- then this function jumps the instruction pointer (i.e. the focus of the
...
-- (])
-- If the byte at the data pointer (i.e. the focus of the Memory zipper) is zero
-- then this function simply increments the instruction pointer (i.e. the focus
-- of the Program zipper).
